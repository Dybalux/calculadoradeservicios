...
function Login() {
    ...
    return (
        <div className="flex items-start sm:items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-4 pt-12 sm:pt-4">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 mt-25 sm:-mt-40">
